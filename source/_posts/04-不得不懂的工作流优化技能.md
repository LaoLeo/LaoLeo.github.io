...
![image](https://user-gold-cdn.xitu.io/2019/11/14/16e6a1df8d3eaacf?w=1406&h=426&f=png&s=58548)

那么人工录入这颗庞大的剧情树的时间成本会制约剧情游戏上线时间，况且这么多数据靠人工操作，那人岂不是要心态爆炸。

有大佬说过：有麻烦的地方，就有机会。谁说的我想不起来。
<center>
    <img width="200" src="https://user-gold-cdn.xitu.io/2019/11/14/16e6a1df8e47a84e?w=218&h=240&f=jpeg&s=10154"></img>
</center>
...
![image](https://user-gold-cdn.xitu.io/2019/11/14/16e6a1df93e0b45c?w=600&h=183&f=png&s=8727)

很简单的一个工作流，把效率不高的环节拆分成多个组合因素，这里的目的主要是录入剧情树的相关信息，把信息分类如下：
![image](https://user-gold-cdn.xitu.io/2019/11/14/16e6a1df8e72c9e0?w=660&h=489&f=png&s=30458)

其中有些信息是可以直接从剧本中去是识别提炼出来形成结构化数据，将这个任务自动化，交给机器来处理，人工只负责剧本不需要出现、数据操作类的信息，那么一下步就是按自动/人工的范畴来重整信息。
![image](https://user-gold-cdn.xitu.io/2019/11/14/16e6a1df8e8ab2cb?w=996&h=577&f=png&s=53658)

右边的就是重整后的信息分类，两个分类可以演化成两个新阶段，机器分析剧本自动化阶段和人工补全阶段，替换掉前面效率低下的部分就可以形成新的工作流：
![image](https://user-gold-cdn.xitu.io/2019/11/14/16e6a1dfb5f6f319?w=720&h=284&f=png&s=6837)

优化升级后的工作流需要一个剧本分析器来为它赋能。

现在的感觉就像仿佛看见了曙光。
<center>
    <img width="200" src="https://user-gold-cdn.xitu.io/2019/11/14/16e6a1dfb6bf84e9?w=247&h=154&f=gif&s=1509541"></img>
</center>
...
<center>
    <img width="200" src="https://user-gold-cdn.xitu.io/2019/11/14/16e6a1dfb8f91029?w=240&h=214&f=jpeg&s=8607"></img>
</center>
...
<!--【图片。gif】-->
![image](https://user-gold-cdn.xitu.io/2019/11/14/16e6a1dfbad27dd9?w=1478&h=511&f=gif&s=351324)

之前完整的配一个复杂的剧情树要配一天，目前只需要两小时不到。在效率上得到了大幅度的提升，对于运营伙伴来说简直是如获至宝，用他们的话来说就是大快人心。

<center>
    <img width="200" src="https://user-gold-cdn.xitu.io/2019/11/14/16e6a1dfd659c0e2?w=346&h=223&f=gif&s=2899543"></img>
</center>
